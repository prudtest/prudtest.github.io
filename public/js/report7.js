...
function makeChart(dataChart){
    ...
    var shift = window.innerHeight/window.innerWidth + 20;
    
    // initiation of the tooltip
    var div = d3.select(".graph7").append("div")	
        .attr("class", "tooltip")				
        .style("opacity", 0);
    ...
    svg7.selectAll(".bar71")
        ...
        .on("mouseover", function(d) {div.html("<p>" + valFormat(d[2]/amp) + " " + lab2 + "</p>" + "<p>Category: " + param["category"] + " "  + d[0] + " </p>")
        .style("opacity",1)
    ...
    svg7.selectAll(".bar72")
        ...
        .on("mouseover", function(d) {div.html("<p>" + valFormat(d[1]/amp) + " " + lab2 + "</p>" + "<p>Category: " + param["category"] + " " + d[0] + " </p>")
        .style("opacity",1)
        .style("left", (event.pageX + 15) + "px")
        .style("top", (event.pageY - $(document).scrollTop ) + "px");})
        .on("mouseout", function (d){ div.style("opacity", 0);});
...
function resetDom() {
    ...
    $(".resultTable7").html('<table id="result7" class="display" width="90%"></table>');
    
    $(".reportOptions").slideToggle();
    $(".selectionSummary").slideToggle();
    $(".reset").slideToggle();
    $("#reportGraph").slideToggle();
    $(".resultTable7").slideUp();
